...
var BASE_PACKAGE = {
  description: 'A full Bifi node build with Bitcore',
  repository: 'https://github.com/sinabs/bitcore',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib': 'https://github.com/sinabs/bitcore-lib.git#bifi',
    'bitcore-node': 'https://github.com/sinabs/bitcore-node.git#bifi',
    'insight-api': 'https://github.com/sinabs/insight-api.git#bifi',
    'insight-ui': 'https://github.com/sinabs/insight.git#bifi'
  }
};

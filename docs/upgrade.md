...
- The `bitcoinfile.conf` file in will need to be updated to include additional indexes *(see below)*.
...
It will also be necessary to update `bitcoinfile.conf` settings, to include these fields:
```
server=1
whitelist=127.0.0.1
txindex=1
